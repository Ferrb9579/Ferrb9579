...
\small{\begin{tabularx}
        ...
        \hline
        B.Tech. (CSE)                & Karunya Institute of Technology and Sciences, Coimbatore & 8.38                     & 2023-2027     \\ %Optional
        \hline
...
\resumeSubheading
  ...
  {Full Stack Developer Intern}{May. 2025 - Aug. 2025}
  \resumeItemListStart
\item {Developed web app using ReactJS, ExpressJS and MongoDB to make a full blown site for OBCFC}
\resumeItemListEnd
...
\resumeProject
  ...
  {ReactJS, TailwindCSS, NodeJS, ExpressJS, Shadcn/UI} %Project Name, Location Name
...
\resumeProject
  {OMS} %Project Name
  {ReactJS, TailwindCSS, NodeJS, ExpressJS, Zustand, MUI} %Project Name, Location Name
  {May. 2025 - Present} %Event Dates

  \resumeItemListStart
    \item {It is a complete management panel for faculty, it comprises of pdf generation, question bank generation, data ingestion, more...}
\resumeItemListEnd
% \resumeProject
...
{ExpressJS, PrismaJS, Tokio, Axum, Discord.js}
\resumeSubItem{Databases: } % Category
{MongoDB, Firestore, Postgres, Redis, SQLite}
...
{Aug. 2025 - Present} %Tenure Period
\resumeSubHeadingListEnd
\vspace{-4mm}
